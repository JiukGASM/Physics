# 3. Solve the simple pendulum problem using pygame library and create a movie.
...
while True:
    ...
    # count += 1
    #
    # filename = "/Users/leejiuk1/Documents/lectureincau/3rd/1semester/computationalphysics/pendulum2/pendulum_%04d.png" % (
